...
import { AppError, deleteKnowledgeQaSchema, ingestTextSchema, NotFoundError, QUEUE_NAMES, removeQaAtIndex, replaceQaAtIndex, updateKnowledgeDocSchema, updateKnowledgeQaSchema, } from "@quickstart-ai/shared";
...
async function enqueueIngest(documentId, projectId) {
    const queue = getIngestQueue();
    try {
        await queue.add("ingest-document", { documentId, projectId }, {
