...
import { assertPublicHttpsUrl, deliverTestPingToIntegration, deliverTestPingToWebhook, maskUrl, } from "@quickstart-ai/events";
import { AppError, createEventRuleSchema, createSlackIntegrationSchema, createDiscordIntegrationSchema, createWebhookSchema, EVENT_CATALOG, EVENT_LIMITS, NotFoundError, updateEventRuleSchema, updateIntegrationSchema, updateWebhookSchema, } from "@quickstart-ai/shared";
...
export async function projectIntegrationsRoutes(app) {
    ...
    app.patch("/api/v1/projects/:id/event-rules/:rid", async (req) => {
        ...
        if (!existing)
            throw new NotFoundError("Event rule not found");
...
//# sourceMappingURL=project-integrations.js.map