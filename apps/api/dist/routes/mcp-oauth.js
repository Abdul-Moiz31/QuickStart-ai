...
import { MCP_SCOPES, createAuthorizationCode, exchangeAuthorizationCode, getOAuthClient, refreshOAuthToken, registerOAuthClient, } from "../mcp/oauth-store.js";
...
export async function mcpOAuthRoutes(app) {
    ...
    app.get("/oauth/authorize", async (req, reply) => {
        ...
        if (q.resource)
            params.set("resource", q.resource);
