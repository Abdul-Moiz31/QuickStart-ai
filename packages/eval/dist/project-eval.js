...
import { createChatClient, createEmbeddingsClient, runAgenticRag, } from "@quickstart-ai/rag";
import { computeEvalReadiness, EVAL_PASS_THRESHOLDS, MIN_KNOWLEDGE_QA, parseKnowledgeQa, buildEmbeddingsRuntimeConfig, buildLlmRuntimeConfig, } from "@quickstart-ai/shared";
import { decryptSecret } from "@quickstart-ai/shared/secrets";
import { casePassed, evaluatePass, runEval } from "./metrics.js";
const MAX_EVAL_CASES = 15;
const CASE_DELAY_MS = 2500;
function sleep(ms) {
    return new Promise((r) => setTimeout(r, ms));
}
async function loadCases(projectId) {
...
async function updateProgress(runId, progress, extra) {
...
export async function executeProjectEval(runId, projectId) {
