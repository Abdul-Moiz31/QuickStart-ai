...
export async function collectAndEmitChatEvents(ctx) {
    const events = [...ctx.agentEvents];
    ...
    events.push(...detectHeuristicEvents({
    ...
    events.push(...buildCustomEventsFromRules(rules, {
        userMessage: ctx.userMessage,
        confidence: ctx.confidence,
