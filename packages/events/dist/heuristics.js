...
const ISSUE_PATTERN = /\b(bug|broken|not working|doesn't work|does not work|error|issue|problem|crash|failed)\b/i;
/**
...
function isKnowledgeGap(ctx) {
    if (typeof ctx.topScore === "number")
        return ctx.topScore < KNOWLEDGE_GAP_TOP_SCORE;
