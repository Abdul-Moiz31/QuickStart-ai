...
export const updateBusinessProfileSchema = onboardingBusinessSchema.partial().refine((data) => Object.keys(data).length > 0, { message: "At least one business field is required" });
